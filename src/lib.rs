...
//const ACCESS_KEY_ALLOWANCE: u128 = 0.5;
...
impl LinkDrop {
    ...
    #[payable]
    pub fn send(&mut self, public_key: PublicKey) -> i8 {
        // assert!(
        //     env::attached_deposit() > ACCESS_KEY_ALLOWANCE,
        //     "Attached deposit must be greater than ACCESS_KEY_ALLOWANCE"
        // );
        if env::attached_deposit() > 10
        {
            env::log_str("Attached deposit must be greater than 10");
            return 0;
        }
        else
        {
